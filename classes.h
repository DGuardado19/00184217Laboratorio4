...
enum parameters {ELEMENT_LENGTH, TAF, KAPA, LAMDA, NI, PSI, ALFA, SIGMA, PI};
...
class mesh{
    ...
    public:
        void setParameters(float l, float taf,float kapa,float lamda,float ni,float psi, float alfa, float sigma, float pi){
